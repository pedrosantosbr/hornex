    ...
    <div className={cn("text-xs sm:text-sm", className)}>
      <label>
        ...
        <input
          ...
          {...props}
          className={cn(
            "mt-1 block h-10 w-full rounded-md border border-gray-700  bg-gray-800 px-4 py-2  text-sm text-gray-100 placeholder-gray-400 transition-shadow duration-200 invalid:border-red-500 invalid:text-red-600 focus:border-gray-500 focus:outline-none focus:ring-1 focus:ring-gray-900 focus:invalid:border-red-500 focus:invalid:ring-red-500 disabled:border-gray-200 disabled:bg-gray-50 disabled:text-gray-500 sm:h-12 sm:rounded-lg",
            inputClassName
          )}
        />
      </label>
